...
public:
    ...
    /**
     * Return the interpolate position between two position(position)
     * 
    ...
    /**
     * Return the interpolate attitude between two attitude(attitude)
     * 
    ...
    /**
     * Return the linear interpolation between two meter
     * 
