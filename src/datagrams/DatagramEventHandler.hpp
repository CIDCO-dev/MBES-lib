...
public:
	...
	*/
	virtual void processDatagramTag(int id){};
         ...
         * @param properties
         */
        virtual void processChannelProperties(unsigned int channelNumber,std::string channelName,unsigned int channelType,std::map<std::string,std::string> * properties){
            delete properties;
        }        
